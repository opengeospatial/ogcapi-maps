...
It is foreseen that future parts will specify other extensions, such as how to specify cartographic layout element to be included on the map,
how to specify a filter for which elements should be included on the map, and possibly how to get information for a point in a map.
