...
An https://petstore.swagger.io/?url=https://schemas.opengis.net/ogcapi/maps/part1/1.0/openapi/ogcapi-maps-1.bundled.json[example OpenAPI definition] for this Standard is available.
