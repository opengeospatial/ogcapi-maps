...
The modular and reusable components used in this example OpenAPI definition can be found at https://schemas.opengis.net/ogcapi/maps/part1/1.0/openapi .
More details on how to adjust and bundle these components can be found in <<rc_oas3>>.
