...
One of the most significant use cases for the definition of the _Maps API_ is the ability to generate maps on the web from one or more servers that can be overlaid into a single view. 
