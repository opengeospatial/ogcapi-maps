...
| _none_                                              | `scale-denominator`, `center`, `width` and `height` | `bbox`
!===
...
| `bbox`, `scale-denominator`, `width` and `height`             | _Error (conflicts with default or provided `mm-per-pixel`)_
...
| `scale-denominator` ^1^                               | `center`, `width` and `height`                      | `bbox`
...
| `scale-denominator`, `center`, `width` and `height` | _None (fully defined combination)_                  | `bbox`
!===
