...
The root of a OGC API represents a dataset that will be exposed in different ways by the API.

The root of a OGC API can be modified or complemented by other resources creating new endpoints indirectly giving access to the modified or complemented dataset. Other OGC API standards will define this mechanism. Examples of standards doing that are:
