...
include::clause_7a_map_paramsBackground.adoc[]

include::clause_7b_map_paramsCartographicLayout.adoc[]
...
include::clause_11_map_paramSpatialSubsetting.adoc[]

include::clause_11b_map_paramSpatialCenterPoint.adoc[]

include::clause_12_map_paramCRS.adoc[]

include::clause_13_map_paramDateTime.adoc[]

include::clause_14_map_originStyle.adoc[]

include::clause_15_map_originDataset.adoc[]

include::clause_16_map_originGeodata.adoc[]

include::clause_17_map_openAPIEncoding.adoc[]

include::clause_18_map_dataEncodings.adoc[]
