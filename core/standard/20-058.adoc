...
:titletext: OGC API - Maps - Part 1: Core
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document: https://www.opengis.net/doc/IS/ogcapi-maps-1/1.0
|Internal reference number of this OGC(R) document: 20-058
|Version: 1.0.0rc2
...
|===
|*Copyright notice*
|Copyright (C) 2019-2024 Open Geospatial Consortium
