...
include::clause_17_map_projection.adoc[]

include::clause_18_map_originCollection.adoc[]

include::clause_19_map_originDataset.adoc[]

include::clause_20_map_originStyle.adoc[]

include::clause_21_map_dataEncodings.adoc[]

include::clause_22_map_openAPI.adoc[]
