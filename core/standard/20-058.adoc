...
include::clause_8_map_paramBackground.adoc[]

include::clause_9_map_paramCollectionsSelection.adoc[]

include::clause_10_map_paramScaling.adoc[]

include::clause_11_map_param_mmPerPixel.adoc[]

include::clause_12_map_paramSpatialSubsetting.adoc[]

include::clause_13_map_paramDateTime.adoc[]

include::clause_14_map_paramGeneralSubsetting.adoc[]

include::clause_15_map_paramCRS.adoc[]

include::clause_16_map_projection.adoc[]

include::clause_17_map_originCollection.adoc[]

include::clause_18_map_originDataset.adoc[]

include::clause_19_map_originStyle.adoc[]

include::clause_20_map_tilesetsList.adoc[]
