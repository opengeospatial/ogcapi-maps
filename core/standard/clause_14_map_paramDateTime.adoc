...
* For Dataset maps, the landing page could specify the temporal extent of the dataset. Maps can be requested inside this extent.
...
The dimensions that can be included within the value of this parameter are defined by the axis name of the generic time in an additional requirement, a permission and a recommendation at the end of this subsection.
