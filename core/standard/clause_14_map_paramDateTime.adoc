...
The Temporal Subsetting requirements class defines the way date and time can be used as a parameter to filter the content in the map resource.
...
A template for the definition of the datatime parameter is available at link:https://beta.schemas.opengis.net/ogcapi/common/part2/0.1/collections/openapi/parameters/datetime.yaml[datetime.yaml].
