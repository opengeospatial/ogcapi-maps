...
Temporarily, it is also possible to combine this building block with _OGC API - Features_ version 1.0 that is not tied to _OGC API - Common_, which can also be substituted for the _OGC API - Common - Part 2_ dependency.
