...
Examples of such standards, all of which also implement _OGC API - Common - Part 2_: Geospatial data_ defining the `/collections` and `/collections/{collectionId}` paths, are:
