...
* https://docs.ogc.org/is/20-057/20-057.html[_OGC API - Tiles_] (coverage tiles and vector tiles)
* https://docs.ogc.org/is/17-069r4/17-069r4.html[_OGC API - Features_]
* https://docs.ogc.org/DRAFTS/19-087.html[_OGC API - Coverages_] (multidimensional data cubes)
