...
This requirements class can be used e.g., in conjunction with the <<rc_dataset-map>> requirements class. A requirements class equivalent to this one is included in _OGC API - Tiles_.
