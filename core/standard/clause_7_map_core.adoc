...
Example of the successful HTTP response headers describing a PNG image with 1500 columns and 616 rows in the WGS 84 / UTM zone 31N CRS centered in the Barcelona area.
