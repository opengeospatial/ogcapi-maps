...
In the context of this Maps API, use of https provides a layer of security to prevent leaking information related to users requesting map data for a particular geographical area,
