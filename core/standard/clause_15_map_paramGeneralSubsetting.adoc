...
When implementing the General Subsetting requirements class, additional dimensions included in an extent description (e.g., as found in a OGC API collection description response)
