...
For the purpose of overlaying map responses from different implementations, a client which does not itself geo-refererence the output based on the `Content-Bbox:` response header
