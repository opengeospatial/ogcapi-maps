...
See also the aspect ratio considerations mentioned at the end of the _Subsetting and scaling the map_ sub-section of the <<overview>>,
regarding aspect ratio of the CRS unit vs. aspect ratio of the corresponding physical units.
