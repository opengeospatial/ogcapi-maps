...
These requirements classes define Map API parameters that can be used together with any map resource.
...
*<<rc_oas3>>*  (https://www.opengis.net/spec/ogcapi-maps-1/1.0/req/oas3)

The _OpenAPI Specification 3_ requirements class specifies requirements for an OpenAPI 3 definition in addition to those defined in _OGC API - Common - Part 1: Core_.
...
| <<rc_oas3>>                  | https://www.opengis.net/spec/ogcapi-maps-1/1.0/conf/oas3
|===
