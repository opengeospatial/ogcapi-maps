...
|===
|Resource name |**Common** path
|Tilesets list |`.../maps/tiles`
|Tileset |`.../maps/tiles/{tileMatrixSetId}`
...
*<<rc_spatial partitioning>>* (http://www.opengis.net/spec/ogcapi-maps-1/1.0/req/spatial-partitioning)
