...
This conformance class can be used e.g. in conjunction with the <<rc_datasetMaps>> conformance class. A conformance class equivalent to this one is included in _OGC API - Tiles_.
