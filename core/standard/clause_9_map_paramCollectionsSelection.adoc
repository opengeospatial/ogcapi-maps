...
This conformance class can be used e.g. in conjunction with the <<rc_datasetMaps>> conformance class or in conjunction with an equivalent conformance class in _OGC API - Tiles_.
