...
For formats resrving a color to define transparency (color key), the combination allows selecting a color that does not interfere with the actual values and colors in the map.
