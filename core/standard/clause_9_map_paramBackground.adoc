...
NOTE: These parameters only apply to CRSs including an invalid area, such as a CRS using an ortographic projection.

include::requirements/background/REQ_void-color-definition.adoc[]

include::recommendations/background/REC_void-color-definition.adoc[]
