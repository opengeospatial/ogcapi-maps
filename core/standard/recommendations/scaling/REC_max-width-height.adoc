      ...
      maps:
        ...
        properties:
          ...
          maxPixels:
            ...
            example: 4194304
----
^|C |An API instance may specify the maximum width and heigth by adding a `minimum` property to the `width` and `heigth` parameter definition in the OpenAPI as in this OpenAPI Specification 3.0 fragment
[source,YAML]
----
  width:
    name: width
