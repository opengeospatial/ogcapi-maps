...
2+|
^1^ service metadata may be provided as an extension of the `info` section of the Open API document as indicated in OGC API - Common - Part 1, Annex B.4 and discussed in the last subsection of the Maps API scaling requirements class section
|===
