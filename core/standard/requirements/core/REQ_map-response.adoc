...
^|E |The "Content-Bbox" coordinates SHALL be in response CRS (indicated in the "Content-Crs" or http://www.opengis.net/def/crs/OGC/1.3/CRS84 if it is not present) and SHALL honor the CRS coordinates order.
