...
^|B |The implementation SHALL include in its response for the `/projections` resource the complete list of custom CRS datums supported for map retrieval operations.
