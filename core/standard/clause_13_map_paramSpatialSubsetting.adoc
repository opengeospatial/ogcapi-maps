...
An example of single value is "150 meters above main sea level" `subset=h(150)`.
...
==== Aspect ratio and scale considerations
...
The "Scaling" requirement class also includes specific <<scaling-aspect-ratio,recommendations for aspect ratio considerations>>.
