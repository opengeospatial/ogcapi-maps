...
NOTE: For clarification: The default CRS of the bbox, center and subset spatial dimensions is http://www.opengis.net/def/crs/OGC/1.3/CRS84 and the default output CRS of the map is native (storage) CRS.
