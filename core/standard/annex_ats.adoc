...
==== Requirement API Operations completeness
[cols=">20h,<80d",width="100%"]
|===
...
==== Requirement API Operation identifiers
[cols=">20h,<80d",width="100%"]
|===
...
|Test method: | *Given:* an API conforming to _OGC API - Common - Part 1: Core_ "Landing Page" conformance class supporting an API definition language with a concept of operation identifiers +
*When:* retrieving the API description +
*Then:* (assert that all parts of the requirement are fully satisfied)
|===
