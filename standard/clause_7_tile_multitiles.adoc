...
==== Parameter f-tile
include::requirements/tiles/multitiles/REQ_mtc-f-tile-definition.adoc[]

==== Response
A successful response of a set of tiles will be consistent with the media type of resource requested. This standard does not impose any media type for the tiles but recommends a ZIP format for the package format.
