...
include::requirements/maps/maps/REQ_sfc-formats.adoc[]
...
include::requirements/maps/maps/REQ_mc-transparent-definition.adoc[]

==== Parameter bgcolor
include::requirements/maps/maps/REQ_mc-bgcolor-definition.adoc[]
