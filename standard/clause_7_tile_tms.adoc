...
==== Operation
include::requirements/tiles/tms/REQ_tilematrixsets-op.adoc[]

==== Response
include::requirements/tiles/tms/REQ_tilematrixsets-success.adoc[]
...
==== Operation
include::requirements/tiles/tms/REQ_tilematrixset-op.adoc[]

==== Response
include::requirements/tiles/tms/REQ_tilematrixset-success.adoc[]

include::requirements/tiles/tms/REQ_REC_tilematrixset-response.adoc[]
...
include::requirements/tiles/tms/REQ_stc-limits.adoc[]
