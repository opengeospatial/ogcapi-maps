...
The landing page provides links to start exploring the resources offered by the API. It mainly consists of a list of links. The core of this standard does not add anything to the links required by OWS Common.
