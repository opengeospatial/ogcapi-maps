...
include::requirements/maps/core/REQ_sfc-map-examples.adoc[]
...
include::recommendations/maps/core/REC_sfc-opaque.adoc[]

include::recommendations/maps/core/REC_sfc-cascaded.adoc[]

=== Maps
include::requirements/maps/core/REQ_mc-map-op.adoc[]

==== Parameter tileMatrixSetId
include::requirements/tiles/core/REQ_mc-styleId-definition.adoc[]
