:Title: OGC API - Maps - Part 2: Scaling and partitioning
:titletext: OGC API - Maps - Part 2: Scaling and partitioning
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
include::clause_7_scaling.adoc[]

include::clause_8_map_bbox.adoc[]

include::clause_9_map_tilesets.adoc[]

include::clause_10_crs.adoc[]
