...
==== Parameter width
The subset of the map will specify the size of the viewport in rows and columns. If the format of the response is a raster image, the size of the image will match the requested width or height.
...
If a client prodides both ...

Recomendation to respect aspect ration

If the client prodides only one

If the client prodides non of them. this a permision.
