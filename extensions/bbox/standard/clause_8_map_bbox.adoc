...
include::requirements/bbox/REQ_link-relation.adoc[]
...
include::recommendations/bbox/REC_link-relation.adoc[]
...
include::recommendations/bbox/REC_scale-denominator.adoc[]
...
include::recommendations/bbox/REC_max-width-height.adoc[]
